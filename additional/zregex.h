...
void regfree(regex_t*);
	...
	/* functions used by grep (nonstandard) */
...
#define REG_LEFT	0x0080	/* implied ^, grep -x (no Kmp) */
#define REG_RIGHT	0x0100	/* implied $, grep -x */
#define REG_LITERAL 	0x0200	/* grep -F (no operators) */
#define REG_AUGMENTED	0x0400	/* allow & and ! operators */
#define REG_WHICH	0x1000	/* enable
